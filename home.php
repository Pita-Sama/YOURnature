...
require_once "php/product/getTableProduct.php";
...
<body>
    ...
    <main>        
        ...
        <div class="products-grid">
            <?php
              ...
              $visualizzazione = getTableProduct($result_prodotti);
    ...
    <script>
        ...
        function filterByCategory(category) {
            ...
            xhr.open('POST', 'php/filter_products_category.php', true);
        ...
        function filter_byName(name){
        	const xhr = new XMLHttpRequest();
            xhr.open("POST","php/filter_byName.php", true);
            xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            xhr.onload = function() {
                if (this.status === 200) {
                    document.querySelector('.products-grid').innerHTML = this.responseText;
